...
> **Note:** This analysis was auto-generated by `scripts/analyze-reference-repo.ts`. Full file statistics and key file paths require the `repository_reference/aider/` directory to be populated via `pnpm reference:import`. See [ADR-0004](../adr/0004-repository-reference-policy.md).
...
Key file paths are populated by `pnpm reference:import`. See [ADR-0004](../adr/0004-repository-reference-policy.md) for the import process.
